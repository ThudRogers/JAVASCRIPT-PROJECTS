...
document.getElementById('add').addEventListener('dblclick', add);
/*this will keep the inputs displayed permanently on the screen*/
show();

/*This function removes a task when the 'x' button is clicked*/
function remove() {
    var id = this.getAttribute('id'); // get index of the task
    var todos = get_todos();

    todos.splice(id, 1); // remove 1 element at position "id"
