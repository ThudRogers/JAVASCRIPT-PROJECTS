...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element[0] === String(squareNumber))) {
        ...
        selectedSquares.push(String(squareNumber) + activePlayer);
...
function computersTurn() {
    ...
    while (!success && selectedSquares.length < 9) {
...
function checkWinConditions() {
    // helper
    const W = (a, b, c) => arrayIncludes(a, b, c);

    // X 0, 1, 2 condition.
    if (W('0X', '1X', '2X')) { drawWinLine(50, 100, 558, 100); }
    // X 3, 4, 5 condition.
    else if (W('3X', '4X', '5X')) { drawWinLine(50, 304, 558, 304); }
    // X 6, 7, 8 condition.
    else if (W('6X', '7X', '8X')) { drawWinLine(50, 508, 558, 508); }
    // X 0, 3, 6 condition.
    else if (W('0X', '3X', '6X')) { drawWinLine(100, 50, 100, 558); }
    // X 1, 4, 7 condition.
    else if (W('1X', '4X', '7X')) { drawWinLine(304, 50, 304, 558); }
    // X 2, 5, 8 condition.
    else if (W('2X', '5X', '8X')) { drawWinLine(508, 50, 508, 558); }
    // X 6, 4, 2 condition.
    else if (W('6X', '4X', '2X')) { drawWinLine(100, 508, 510, 90); }
    // X 0, 4, 8 condition.
    else if (W('0X', '4X', '8X')) { drawWinLine(100, 100, 520, 520); }

    // O 0, 1, 2 condition.
    else if (W('0O', '1O', '2O')) { drawWinLine(50, 100, 558, 100); }
    // O 3, 4, 5 condition.
    else if (W('3O', '4O', '5O')) { drawWinLine(50, 304, 558, 304); }
    // O 6, 7, 8 condition.
    else if (W('6O', '7O', '8O')) { drawWinLine(50, 508, 558, 508); }
    // O 0, 3, 6 condition.
    else if (W('0O', '3O', '6O')) { drawWinLine(100, 50, 100, 558); }
    // O 1, 4, 7 condition.
    else if (W('1O', '4O', '7O')) { drawWinLine(304, 50, 304, 558); }
    // O 2, 5, 8 condition.
    else if (W('2O', '5O', '8O')) { drawWinLine(508, 50, 508, 558); }
    // O 6, 4, 2 condition.
    else if (W('6O', '4O', '2O')) { drawWinLine(100, 508, 510, 90); }
    // O 0, 4, 8 condition.
    else if (W('0O', '4O', '8O')) { drawWinLine(100, 100, 520, 520); }
